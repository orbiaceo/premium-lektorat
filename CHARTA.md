...
**Trennungsregel (verbindlich, siehe Ledger #003):**
Kein sichtbarer Text steht im Code. Alle Seiteninhalte liegen unter
`content/` als Markdown oder JSON. Der Code liest Inhalte, er enthält
sie nicht. Das ist die Voraussetzung dafür, dass später eine
Redaktionsoberfläche ohne Umbau ergänzt werden kann.
...
G-01 und G-03 sind noch nicht entschieden. Sie stehen bewusst hier und nicht im
Code, weil sie das Fundament betreffen. Bis zur Entscheidung gilt jeweils
die Empfehlung als Arbeitsannahme — **markiert, nicht gesetzt.**
...
**Status: entschieden (Ledger #003)**

**Phase 1 — gilt jetzt:** Alle Inhalte als Markdown/JSON unter `content/`
im Repo. Kein Admin-Bereich, kein CMS. Pflege über den GitHub-Web-Editor
oder durch die Entwicklung.

**Phase 2 — später, nicht beauftragt:** Redaktionsoberfläche unter
`/admin` kann nachgerüstet werden. Die Wahl des Werkzeugs bleibt bewusst
offen und wird erst bei Beauftragung getroffen.

Supabase ist ausschließlich für Formularrückläufe zuständig, nicht für
Seiteninhalte.
